...
exports.searchRestaurantsByCity = exports.searchNearbyRestaurants = void 0;
...
const searchRestaurantsByCity = (query, location) => __awaiter(void 0, void 0, void 0, function* () {
    // Search for the restaurants in a range of MAX_DISTANCE meters, ordered by simlarity to the query and capped at LIMIT results.
    const URL = `${urls_1.RESTAURANTS_URL}search-restaurants?query=${query}&city=${location}`;
    const config = {
        headers: {
            'ngrok-skip-browser-warning ': 'true',
        },
